...
class CEstadisticas extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = [
            ...
            'generoMencion' => ['Bioimagenología', 'Fisioterapia y Kinesiología', 'Laboratorio Clínico'],
            'cantGeneroMasculino' => [$tgeneroBM, $tgeneroFM, $tgeneroLM],
            'cantGeneroFemenino' => [$tgeneroBF, $tgeneroFF, $tgeneroLF],
            ...
            'residenciaMencion' => ['Bioimagenología', 'Fisioterapia y Kinesiología', 'Laboratorio Clínico'],
            'cantlapazMencion' => [$totallapazb, $totallapazf, $totallapazl],
            'cantelaltoMencion' => [$totalelaltob, $totalelaltof, $totalelaltol],
            'cantnacionalesMencion' => [$totalnacionalb, $totalnacionalf, $totalnacionall],
            'cantinternacionalesMencion' => [$totalinternacionalesb, $totalinternacionalesf, $totalinternacionalesl],
            ...
            'permanenciaMencion' => ['Bioimagenología', 'Fisioterapia y Kinesiología', 'Laboratorio Clínico'],
            'permanencia3' => [$permanencia3b, $permanencia3f, $permanencia3l],
            'permanencia4' => [$permanencia4b, $permanencia4f, $permanencia4l],
            'permanencia5' => [$permanencia5b, $permanencia5f, $permanencia5l],
            'permanencia6' => [$permanencia6b, $permanencia6f, $permanencia6l],
            'permanencia7' => [$permanencia7b, $permanencia7f, $permanencia7l],
            'permanencia8' => [$permanencia8b, $permanencia8f, $permanencia8l],
            'permanencia9' => [$permanencia9b, $permanencia9f, $permanencia9l],
            'permanencia10' => [$permanencia10b, $permanencia10f, $permanencia10l],
            ...
            'edadMencion' => ['Bioimagenología', 'Fisioterapia y Kinesiología', 'Laboratorio Clínico'],
            'edad1' => [$p20a22b, $p20a22f, $p20a22l],
            'edad2' => [$p23a26b, $p23a26f, $p23a26l],
            'edad3' => [$p27a32b, $p27a32f, $p27a32l],
            'edad4' => [$p33a39b, $p33a39f, $p33a39l],
            'edad5' => [$p40a46b, $p40a46f, $p40a46l],
            'edad6' => [$p47a55b, $p47a55f, $p47a55l],
            'edad7' => [$pmaya55b, $pmaya55f, $pmaya55l]
        ];
